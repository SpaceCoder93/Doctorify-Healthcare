...
class PrognosisOutputPage extends StatefulWidget {
  final List<dynamic> finallist;
    const PrognosisOutputPage({
    super.key, 
    required this.finallist,
  });
  @override
  State<StatefulWidget> createState() {
    return PrognosisOutputPageState();
  }
}

class PrognosisOutputPageState extends State<PrognosisOutputPage> {
  String d1 = "";
  String d2 = "";
  String d3 = "";
  String d4 = "";
