...
class MobilePrognosisInputPage extends StatefulWidget {
  const MobilePrognosisInputPage({super.key});
  @override
  State<StatefulWidget> createState() {
    return MobilePrognosisInputPageState();
  }
}

class MobilePrognosisInputPageState extends State<MobilePrognosisInputPage> {
              ...
              Expanded(
                child: Align(
                  ...
                  child: Padding(
                    ...
                    onPressed: () async {
                      OverlayLoadingProgress.start(context, gifOrImagePath: 'assets/animations/loading.gif');
                      await Future.delayed(const Duration(seconds: 3));
                      List<String> prediction = await DiseasePredict().fetchAlbum(finalsend);
                      ...
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => MobileResultPage(finallist: send)));
